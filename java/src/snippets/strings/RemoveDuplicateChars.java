...
public class RemoveDuplicateChars {
    ...
    public static String removeDuplicateLettersFast(String s) {
    ...
    public static void main(String [] args){
        System.out.println(removeDuplicateLetters("concatenation"));
        System.out.println(removeDuplicateLettersFast("concatenation"));
    }
}